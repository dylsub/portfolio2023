...
changeSide(newCount);
newCount++
let cubeLoop = setInterval(() => {
    newCount = changeSide(newCount)
}, 2000);

function changeSide(cubeCount) {
    let sides = ["front", "left", "top", "back", "right", "bottom"]
    var showClass = 'show-' + sides[cubeCount]
    if (currentClass) {
